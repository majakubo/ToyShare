# Generated by Django 2.1.1 on 2019-04-06 06:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='renting',
            name='toy_id_ref',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='toyshare.Toy'),
        ),
        migrations.AddField(
            model_name='renting',
            name='user_id_ref',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_id', to='toyshare.ExtUser'),
        ),
        migrations.AddField(
            model_name='rate',
            name='renting_id_ref',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='toyshare.Renting'),
        ),
        migrations.AddField(
            model_name='rate',
            name='user_id_ref',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='toyshare.ExtUser'),
        ),
    ]
